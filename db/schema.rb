...
ActiveRecord::Schema[7.1].define(version: 2024_03_16_000302) do
  ...
  create_table "fees_charges", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "merchant_id", null: false
    ...
    t.datetime "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["merchant_id", "date"], name: "index_fees_charges_on_merchant_id_and_date", unique: true
    t.index ["merchant_id"], name: "index_fees_charges_on_merchant_id"
  end
  ...
  add_foreign_key "fees_charges", "merchants"
